...
class TemplatesPanel(Panel):
    """
    A panel that lists all user used during processing of a response.
    """
    ...
    def _store_template_info(self, sender, **kwargs):
        ...
        # Skip user that we are generating through the debug toolbar.
    ...
    template = "debug_toolbar/panels/user.html"
    ...
    def generate_stats(self, request, response):
        ...
        if self.templates:
            ...
            # django user have the 'engine' attribute, while jinja
            # user use 'backend'
